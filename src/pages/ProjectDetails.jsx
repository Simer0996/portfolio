                    ...
                    {id === project.id ?
                        <div className="mt-[-90px]">
                            ...
                            <div className="flex justify-center align-middle pt-[10px]">
                                <a href={project.github}><button className="bg-white p-2 buttonStyling">View Source</button></a>
                                <a href={project.link}><button className="bg-white p-2 ml-[20px] buttonStyling"> Live Site</button></a>
                            </div>
                        </div> : <></>}
                </div>
            ))}
